...
function training_RSVPLoopBegin(thisScheduler) {
  ...
  // Schedule all the trials in the trialList:
  training_RSVP.forEach(function() {
...
function training_TrialCodeRoutineBegin(trials) {
  return function () {
    ...
    training_TrialCodeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function trainingRSVPcodeRoutineBegin(trials) {
  return function () {
    ...
    trainingRSVPcodeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function training_RSVPtrialRoutineBegin(trials) {
  return function () {
    ...
    training_RSVPtrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function training_ResponseT1RoutineBegin(trials) {
  return function () {
    ...
    training_ResponseT1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function training_ResponseT2RoutineBegin(trials) {
  return function () {
    ...
    training_ResponseT2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function trainingResultsRoutineBegin(trials) {
  return function () {
    ...
    trainingResultsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function experimentInstructionsRoutineBegin(trials) {
  return function () {
    ...
    experimentInstructionsComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function RSVPcodeRoutineBegin(trials) {
  return function () {
    ...
    RSVPcodeComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function RSVPTrialRoutineBegin(trials) {
  return function () {
    ...
    RSVPTrialComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function ResponseT1RoutineBegin(trials) {
  return function () {
    ...
    ResponseT1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function ResponseT2RoutineBegin(trials) {
  return function () {
    ...
    ResponseT2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
...
function ContSpaceRoutineBegin(trials) {
  return function () {
    ...
    ContSpaceComponents.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
